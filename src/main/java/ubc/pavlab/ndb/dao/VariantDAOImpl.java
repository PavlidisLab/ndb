...
public class VariantDAOImpl implements VariantDAO {
    ...
    private static final String SQL_STAR = "id, paper_id, raw_variant_id, event_id, subject_id, sample_id, chromosome, start_hg19, stop_hg19, ref, alt, gene, category, gene_detail, func, aa_change, cytoband, denovo, lof";
    ...
    private static VariantDTO map( ResultSet resultSet ) throws SQLException {
        return new VariantDTO( resultSet.getInt( "id" ), resultSet.getInt( "paper_id" ),
                ...
                resultSet.getString( "cytoband" ), resultSet.getString( "denovo" ), resultSet.getString( "lof" ) );
    }
